...
<nav class="navbar">
    <div class="nav-menu">
        <ul class="menu">
            <li><a class="active" href="<%=jhsBasePath%>home.do">首页</a></li>
            <li><a href="<%=jhsBasePath%>book/store">书籍良品</a></li>
            <li><a href="#">求书区</a></li>
            <li><a href="#">服务区</a></li>
        </ul>
    </div><!-- nav-menu -->
    <div class="nav-search">
        <form action="<%=jhsBasePath%>book/search" method="post">
            ...
            <button class="search-logo"><i class="fa fa-search fa-lg"></i></button>
        </form>
    </div>
    <div class="nav-info">
        <a href="<%=jhsBasePath%>user/MyInfoView" class="username">${user.getName()}</a>
        <a href="<%=jhsBasePath%>user/mystall.do" class="bookshelf">||&nbsp;&nbsp;&nbsp;我的书架</a>
        <a href="<%=jhsBasePath%>user/logout" class="logout">[ 退 出 ]</a>
    </div> <!-- nav-info-end -->
</nav>
<div class="titleName">
    <h3>上传二手书</h3>
...
<div class="container">
    <form enctype="multipart/form-data" id="bookForm" class="upload-form" action="<%=jhsBasePath%>book/add"
          method="post">
        <p>
            <span class="pic-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            上传书图片： <input type="file" accept="image/*" name="images">
        </p>
        <p>
        ...
        <input type="submit" class="submit-btn" id="book-submit" value="提交">
    </form>
</div>
...
<script src="<%=jhsBasePath%>js/jquery-3.2.js"></script>
<script src="<%=jhsBasePath%>js/upload.js"></script>
<script src="<%=jhsBasePath%>js/jquery.form.js"></script>
<script>
